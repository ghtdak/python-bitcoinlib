...
class Test_CBloomFilter(unittest.TestCase):
    ...
    def test_create_insert_serialize(self):
        ...
        self.assertEqual(filter.serialize(),
    ...
    def test_bloom_create_insert_key(self):
        ...
        pubkey = unhexlify(
            b'045B81F0017E2091E2EDCD5EECF10D5BDD120A5514CB3EE65B8447EC18BFC4575C6D5BF415E54E03B1067934A0F0BA76B01C6B9AB227142EE1D543764B69D901E0')
