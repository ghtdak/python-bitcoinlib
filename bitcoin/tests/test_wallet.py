...
class Test_CBitcoinAddress(unittest.TestCase):
    ...
    def test_create_from_string(self):
        ...
        T('1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
          x('62e907b15cbf27d5425399ebf6f0fb50ebb88f18'), 0, P2PKHBitcoinAddress)
    ...
    def test_from_scriptPubKey(self):
        ...
        T('a914000000000000000000000000000000000000000087',
          '31h1vYVSYuKP6AhS86fbRdMw9XHieotbST', P2SHBitcoinAddress)
        T('76a914000000000000000000000000000000000000000088ac',
          '1111111111111111111114oLvT2', P2PKHBitcoinAddress)
    ...
    def test_from_nonstd_scriptPubKey(self):
        ...
        scriptPubKey = CScript(x(
            'a94c14000000000000000000000000000000000000000087'))
        with self.assertRaises(CBitcoinAddressError):
        ...
        # One extra byte
        scriptPubKey = CScript(x(
            '76a914000000000000000000000000000000000000000088acac'))
        with self.assertRaises(CBitcoinAddressError):
            CBitcoinAddress.from_scriptPubKey(scriptPubKey)
    ...
    def test_from_invalid_scriptPubKey(self):
        ...
        # Truncated P2PKH
        scriptPubKey = CScript(x(
            '76a91400000000000000000000000000000000000000'))
        with self.assertRaises(CBitcoinAddressError):
            CBitcoinAddress.from_scriptPubKey(scriptPubKey)
    ...
    def test_to_scriptPubKey(self):
        ...
        def T(str_addr, expected_scriptPubKey_hexbytes):
            ...
            self.assertEqual(
                b2x(actual_scriptPubKey), expected_scriptPubKey_hexbytes)
...
class Test_P2PKHBitcoinAddress(unittest.TestCase):
    ...
    def test_from_bare_checksig_scriptPubKey(self):
        ...
        with self.assertRaises(CBitcoinAddressError):
            P2PKHBitcoinAddress.from_scriptPubKey(x(
    ...
    def test_from_invalid_pubkeys(self):
        ...
        with self.assertRaises(CBitcoinAddressError):
            P2PKHBitcoinAddress.from_pubkey(CPubKey(x(
                '0378d430274f8c5ec1321338151e9f27f4c676a008bdf8638d07c0b6be9ab35c72')))
